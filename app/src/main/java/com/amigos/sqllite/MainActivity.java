...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new DatabaseHandler(this);
            db.addPerson(new Person("Muhammed","faycal","sougueur",36));
           db.addPerson(new Person("Ahmed","Omer","tiaret",22));
        //    db.addPerson(new Person("Ali","khalid","oran",44));
        //   db.addPerson(new Person("Osama","Saif","steif",55));
